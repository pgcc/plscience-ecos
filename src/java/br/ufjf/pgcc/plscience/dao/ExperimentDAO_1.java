 ...
 */
/* do tassio passar para o do vitor*/
 ...
 * @author tassio
 */
public class ExperimentDAO_1 {
    
    public static ExperimentDAO_1 expirimentDAO;

    public static ExperimentDAO_1 getInstance() {
        if (expirimentDAO == null) {
            expirimentDAO = new ExperimentDAO_1();
        }
