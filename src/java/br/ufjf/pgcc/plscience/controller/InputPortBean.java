 ...
 * @author tassio
 */
@ManagedBean(name = "inputPortBean")
@ViewScoped
public class InputPortBean {
    ...
    public InputPortBean() {
        inputPorts = new InputPortDAO().buscarTodas();
        inputPort = new InputPort();
    }
    
    public List<InputPort> buscartaskport(int idworkflow) {
        inputPorts = (List) new InputPortDAO().buscar(idworkflow);
        return inputPorts;
    }

    public void record(ActionEvent actionEvent) {
        new InputPortDAO().persistir(inputPort);
        inputPorts = (List) new InputPortDAO().buscarTodas();
        inputPort = new InputPort();
    }

    public void exclude(ActionEvent actionEvent) {
        new InputPortDAO().remover(inputPort);
        inputPorts = new InputPortDAO().buscarTodas();
        inputPort = new InputPort();
    }
